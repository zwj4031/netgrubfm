...
grub_target_cc_version='aarch64-linux-gcc (GCC) 9.2.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=ARM64_EFI -nostdinc -isystem /tmp/cross/gcc-9.2.0-nolibc/aarch64-linux/bin/../lib/gcc/aarch64-linux/9.2.0/include -I$(top_srcdir)/include -I$(top_builddir)/include'
