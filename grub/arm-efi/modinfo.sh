...
grub_target_cc_version='arm-linux-gnueabi-gcc (GCC) 8.1.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=ARM_EFI -mword-relocations -nostdinc -isystem /tmp/cross/gcc-8.1.0-nolibc/arm-linux-gnueabi/bin/../lib/gcc/arm-linux-gnueabi/8.1.0/include -I$(top_srcdir)/include -I$(top_builddir)/include'
