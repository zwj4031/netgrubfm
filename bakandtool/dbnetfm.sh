...
tar -zcvf buildnetinstall-$(date +%Y%m%d-%H%M).tar.gz buildnetinstall/ --exclude=buildnetinstall/.git --exclude=buildnetinstall/.github --exclude=buildnetinstall/.vs --exclude=buildnetinstall/tftpboot;
