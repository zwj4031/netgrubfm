...
tar -zcvf diygrubfm-$(date +%Y%m%d-%H%M).tar.gz diygrubfm/ --exclude=diygrubfm/.git --exclude=diygrubfm/.github --exclude=diygrubfm/.vs --exclude=diygrubfm/updates.gz;
...
cp diygrubfm-$(date +%Y%m%d-%H)*.tar.gz /mnt/m/同步/顶点home/2020研究pe专用/grub2研究包/;