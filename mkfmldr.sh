#!/usr/bin/env sh
echo "x86_64-efi"
mkdir buildfmldr/boot/grubfm/x86_64-efi
cd buildfmldr
...
grub-mkimage -m ./buildfmldr/memdisk.cpio -d ./grub/x86_64-efi -p "(memdisk)/boot/grubfm" -c arch/x64-pxe/fmldr.cfg -o fmldr.efi -O x86_64-efi $modules
